...
// $GALACTICA Protocol Source Code
...
contract GALACTICA is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'GALACTICA';
    string  private constant _SYMBOL = 'GALACTICA';
    ...
    uint256 private     _TAX_FEE = 200; // 2% RFI
    uint256 private    _BURN_FEE = 200; // 2% BURNED
    uint256 private _CHARITY_FEE = 600; // 6% LOTTERY WALLET
